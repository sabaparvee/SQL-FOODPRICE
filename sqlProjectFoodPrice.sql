SELECT * FROM foodprice.food_prices_indtable;
-- Q1. Count of records
SELECT COUNT(DATE)
FROM foodprice.food_prices_indtable;
...
SELECT COUNT(distinct ADMIN1)  AS STATE FROM foodprice.food_prices_indtable
...
from zones zo
JOIN foodprice.food_prices_indtable fo
